const latestArticle = {
  ...
  "executive_summary": [
    {
      "title": "核心结论 1",
      "content": "本次采集得到论文 14 篇、GitHub 项目 20 个、行业/公司动态 20 条。",
      "card_type": "核心摘要卡",
      "importance_score": 96,
      "tags": [
        "具身智能"
  ...
  "papers": [
    {
      ...
      "source_url": "http://arxiv.org/abs/2609.05404v1",
      "card_type": "重点论文卡",
      "importance_score": 94,
      "tags": [
        "具身智能",
    ...
    },
    {
      ...
      "source_url": "http://arxiv.org/abs/2609.05376v1",
      "card_type": "重点论文卡",
      "importance_score": 88,
      "tags": [
        "具身智能",
  ...
  "github_projects": [
    {
      ...
      "why_follow": "仓库星标数约为 29901，可用于观察开源社区对仿真到真实迁移的实现方向。",
    ...
    },
    {
      ...
      "why_follow": "仓库星标数约为 2459，可用于观察开源社区对人形机器人控制的实现方向。",
    ...
    },
    {
      ...
      "summary": "该项目可能聚焦仿真到真实迁移，主要语言为 Python。",
      "why_follow": "仓库星标数约为 2370，可用于观察开源社区对仿真到真实迁移的实现方向。",
    ...
    },
    {
      ...
      "summary": "该项目可能聚焦仿真到真实迁移，主要语言为 Python。",
      "why_follow": "仓库星标数约为 730，可用于观察开源社区对仿真到真实迁移的实现方向。",
    ...
    },
    {
      ...
      "why_follow": "仓库星标数约为 654，可用于观察开源社区对视觉-语言-动作模型的实现方向。",
  ...
  "industry_updates": [
    ...
    },
    {
      ...
      "impact": "可作为跟踪产业落地、公司研发投入和招聘需求变化的线索。",
      "source_url": "https://www.therobotreport.com/massrobotics-shares-member-survey-results-around-fcc-restrictions/",
      "card_type": "行业动态卡",
      "importance_score": 80,
      "tags": [
        "具身智能",
  ...
  "sources": [
    ...
    {
      "name": "行业动态 3：人形机器人控制",
      "url": "https://spectrum.ieee.org/blood-draw-robot-vitestro-aletta",
      "type": "行业动态",
      "card_type": "来源链接卡",
      "importance_score": 60
    },
