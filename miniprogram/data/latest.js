const latestArticle = {
  ...
  "papers": [
    ...
    },
    {
      ...
      "source_url": "http://arxiv.org/abs/2607.29596v1",
      "card_type": "重点论文卡",
      "importance_score": 88,
      "tags": [
        "具身智能",
  ...
  "github_projects": [
    {
      ...
      "why_follow": "仓库星标数约为 29687，可用于观察开源社区对仿真到真实迁移的实现方向。",
    ...
    },
    {
      ...
      "why_follow": "仓库星标数约为 15213，可用于观察开源社区对人形机器人控制的实现方向。",
    ...
    },
    {
      ...
      "summary": "该项目可能聚焦仿真到真实迁移，主要语言为 Python。",
      "why_follow": "仓库星标数约为 2232，可用于观察开源社区对仿真到真实迁移的实现方向。",
    ...
    },
    {
      ...
      "summary": "该项目可能聚焦人形机器人控制，主要语言为 未知。",
      "why_follow": "仓库星标数约为 2231，可用于观察开源社区对人形机器人控制的实现方向。",
    ...
    },
    {
      ...
      "why_follow": "仓库星标数约为 588，可用于观察开源社区对视觉-语言-动作模型的实现方向。",
  ...
  "industry_updates": [
    ...
    },
    {
      ...
      "impact": "可作为跟踪产业落地、公司研发投入和招聘需求变化的线索。",
      "source_url": "https://www.therobotreport.com/hebi-robotics-earns-nasa-sbir-grant-fast-track-miniaturized-actuators/",
      "card_type": "行业动态卡",
      "importance_score": 83,
      "tags": [
        "具身智能"
    ...
    {
      "title": "行业动态 3：扩散策略机器人控制",
      "summary": "该动态与扩散策略机器人控制相关，建议配置 OpenAI API Key 后生成更准确的中文摘要。",
      "impact": "可作为跟踪产业落地、公司研发投入和招聘需求变化的线索。",
      "source_url": "https://spectrum.ieee.org/humanoid-robots-walden-robotics-toyota",
      "card_type": "行业动态卡",
      "importance_score": 80,
      "tags": [
        "具身智能",
    ...
    },
    {
      ...
      "summary": "该动态与视觉-语言-动作模型相关，建议配置 OpenAI API Key 后生成更准确的中文摘要。",
      "impact": "可作为跟踪产业落地、公司研发投入和招聘需求变化的线索。",
      "source_url": "https://www.therobotreport.com/reimagine-robotics-emerges-stealth-with-robotslearn-on-the-job/",
      "card_type": "行业动态卡",
      "importance_score": 77,
      "tags": [
        "具身智能",
  ...
  "sources": [
    {
      "name": "论文 1：仿真到真实迁移",
      "url": "http://arxiv.org/abs/2607.29625v1",
      "type": "论文",
      "card_type": "来源链接卡",
      "importance_score": 81
    },
    ...
    },
    {
      ...
      "url": "http://arxiv.org/abs/2607.29596v1",
      "type": "论文",
      "card_type": "来源链接卡",
      "importance_score": 72
    },
    {
      ...
      "url": "http://arxiv.org/abs/2607.29569v1",
      "type": "论文",
      "card_type": "来源链接卡",
      "importance_score": 69
    },
    {
      "name": "论文 5：扩散策略机器人控制",
      "url": "http://arxiv.org/abs/2607.29482v1",
      "type": "论文",
      "card_type": "来源链接卡",
      "importance_score": 66
    },
    ...
    },
    {
      ...
      "url": "https://www.therobotreport.com/hebi-robotics-earns-nasa-sbir-grant-fast-track-miniaturized-actuators/",
      "type": "行业动态",
      "card_type": "来源链接卡",
      "importance_score": 60
    },
    {
      "name": "行业动态 3：扩散策略机器人控制",
    ...
    },
    {
      ...
      "url": "https://www.therobotreport.com/reimagine-robotics-emerges-stealth-with-robotslearn-on-the-job/",
      "type": "行业动态",
      "card_type": "来源链接卡",
      "importance_score": 60
    },
