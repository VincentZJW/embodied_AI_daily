const latestArticle = {
  ...
  "github_projects": [
    {
      ...
      "why_follow": "仓库星标数约为 29713，可用于观察开源社区对仿真到真实迁移的实现方向。",
    ...
    },
    {
      ...
      "why_follow": "仓库星标数约为 15307，可用于观察开源社区对人形机器人控制的实现方向。",
    ...
    },
    {
      ...
      "summary": "该项目可能聚焦人形机器人控制，主要语言为 未知。",
      "why_follow": "仓库星标数约为 2266，可用于观察开源社区对人形机器人控制的实现方向。",
    ...
    },
    {
      ...
      "summary": "该项目可能聚焦仿真到真实迁移，主要语言为 Python。",
      "why_follow": "仓库星标数约为 2247，可用于观察开源社区对仿真到真实迁移的实现方向。",
    ...
    },
    {
      ...
      "why_follow": "仓库星标数约为 597，可用于观察开源社区对视觉-语言-动作模型的实现方向。",
  ...
  "industry_updates": [
    ...
    },
    {
      ...
      "summary": "该动态与人形机器人控制相关，建议配置 OpenAI API Key 后生成更准确的中文摘要。",
      "impact": "可作为跟踪产业落地、公司研发投入和招聘需求变化的线索。",
      "source_url": "https://spectrum.ieee.org/video-friday-heavy-lift-drone",
      "card_type": "行业动态卡",
      "importance_score": 84,
      "tags": [
        "具身智能",
  ...
  "sources": [
    ...
    {
      "name": "行业动态 3：人形机器人控制",
      "url": "https://spectrum.ieee.org/video-friday-heavy-lift-drone",
      "type": "行业动态",
      "card_type": "来源链接卡",
      "importance_score": 60
    },
